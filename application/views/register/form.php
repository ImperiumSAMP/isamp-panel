	...
	<?php echo form_open('register'); ?>
		<div class="reg-sub">
			...
			<div class="login-field">
				...
				<span class="field-input"><input type="text" title="Nombre y apellido del personaje en formato Nombre_Apellido. Este será, además, tu nombre de usuario para ingresar al servidor." name="name" value="<?php echo set_value('name')?>" size="40" /></span>
			</div>
			...
			<div class="login-field">
				...
				<span class="field-input"><input type="text" name="age" title="Edad del personaje." value="<?php echo set_value('age')?>" size="40" /></span>
			</div>
			
			<div class="login-field">
				<span class="field-title"><h5>Lugar de nacimiento / origen</h5></span>
			    <?php echo form_error('birthplace'); ?>
				<span class="field-input"><input type="text" name="birthplace" title="Ciudad de origen de tu personaje. Puede ser una ciudad real, o una ficticia compatible con el universo de Malos Aires. NO son válidas los ciudades del GTA." value="<?php echo set_value('birthplace')?>" size="40" /></span>
			</div>
			
			<div class="login-field">
				<span class="field-title"><h5>Descripción física ((bio))</h5></span>
			    <?php echo form_error('bio'); ?>
				<span class="field-input"><textarea name="bio" title="Descripción física del personaje, ser&aacute; visible IG." maxlength="300" rows="5" cols="37"><?php echo set_value('bio')?></textarea></span>
			</div>
		</div>
		<div class="reg-sub">
			<h2>Datos OOC</h2>
			...
			<div class="login-field">
				...
				<span class="field-input"><input type="text" name="realname" title="Tu nombre en la vida real" value="<?php echo set_value('realname')?>" size="40" /></span>
			</div>
			
			<div class="login-field">
				<span class="field-title"><h5>Edad</h5></span>
			    <?php echo form_error('realage'); ?>
				<span class="field-input"><input type="text" name="realage" title="Tu edad en la vida real" value="<?php echo set_value('realage')?>" size="40" /></span>
			</div>
		
			<div class="login-field">
				<span class="field-title"><h5>E-mail</h5></span>
		        <?php echo form_error('email'); ?>	
				<span class="field-input"><input type="text" name="email" title="Direccion de correo para recuperar tu cuenta y recibir notificaciones." value="<?php echo set_value('email')?>" size="40" /></span>
			</div>
		
			<div class="login-field">
				<span class="field-title"><h5>Nombre de usuario en el foro</h5></span>
		        <?php echo form_error('forumuser'); ?>	
				<span class="field-input"><input type="text" name="forumuser" title="Necesitas un usuario en el foro de Pheek.net. Si no ten&eacute;s uno, por favor crealo antes de registrar tu cuenta." value="<?php echo set_value('forumuser')?>" size="40" /></span>
			</div>
	
			<div class="login-field">
				<span class="field-title"><h5>Resumen de la historia del personaje</h5></span>
	            <?php echo form_error('story'); ?>
				<span class="field-input"><textarea name="story" title="Escribe brevemente la historia de tu personaje y como llega a la ciudad." maxlength="1000" rows="5" cols="37"><?php echo set_value('story')?></textarea></span>
			</div>
